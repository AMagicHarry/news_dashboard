                    ...
                    <div className="mt-20 text-center items-center md:p-10 flex-col justify-center w-2/3 p-3 leading-8">
                        ...
                        <div className='text-center flex-col w-full'>
                            ...
                            <div className='flex flex-wrap justify-center'>
                                <Link to="/news" className="bg-red-700 text-white w-80 mt-5 rounded-md py-1">Login</Link>
                                <label className='w-80 mr-auto mt-5'>
                                    <input type="checkbox" className='bg-red-700 '></input>   Forgot password
                                </label>
                                <Link to="/register" className="bg-red-700 text-white w-80 mt-5 rounded-md py-1">Register</Link>
                            </div>
                        </div>
                    </div>
                </div>
